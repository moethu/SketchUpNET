...
*/
SU_RESULT SULayerFolderCreate(SULayerFolderRef* layer_folder,
                              const char* name);
...
- \ref SU_ERROR_INVALID_OUTPUT if \p name does not point to a valid \ref
  SUStringRef object
*/
SU_RESULT SULayerFolderGetName(SULayerFolderRef layer_folder,
                               SUStringRef* name);
...
*/
SU_RESULT SULayerFolderGetVisibility(SULayerFolderRef layer_folder,
                                     bool* visible);
...
- \ref SU_ERROR_INVALID_INPUT if \p layer_folder is not a valid object.
*/
SU_RESULT SULayerFolderSetVisibility(SULayerFolderRef layer_folder,
                                     bool visible);
...
- \ref SU_ERROR_NULL_POINTER_OUTPUT if \p visible is NULL
*/
SU_RESULT SULayerGroupGetVisibleOnNewScenes(SULayerFolderRef layer_folder,
                                            bool* visible);
...
- \ref SU_ERROR_INVALID_INPUT if \p layer_folder is not a valid object.
*/
SU_RESULT SULayerGroupSetVisibleOnNewScenes(SULayerFolderRef layer_folder,
                                            bool visible);
...
*/
SU_RESULT SULayerFolderAddLayer(SULayerFolderRef layer_folder,
                                SULayerRef layer);
...
*/
SU_RESULT SULayerFolderRemoveLayer(SULayerFolderRef layer_folder,
                                   SULayerRef layer);
...
*/
SU_RESULT SULayerFolderGetNumLayers(SULayerFolderRef layer_folder,
                                    size_t* count);
...
*/
SU_RESULT SULayerFolderGetLayers(SULayerFolderRef layer_folder,
                                 size_t len,
                                 SULayerRef* layers,
                                 size_t* count);
 ...
 */
SU_RESULT SULayerFolderAddLayerFolder(SULayerFolderRef layer_folder, 
...
/**
 ...
 - \ref SU_ERROR_NULL_POINTER_OUTPUT if \p count is NULL
*/
SU_RESULT SULayerFolderGetNumLayerFolders(SULayerFolderRef layer_folder, 
                                          size_t* count);
...
*/
SU_RESULT SULayerFolderGetLayerFolders(SULayerFolderRef layer_folder, 
                                       size_t len, 
...
/**
 ...
 folder
*/
SU_RESULT SULayerFolderGetParentLayerFolder(SULayerFolderRef layer_folder, 
