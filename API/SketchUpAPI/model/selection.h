...
*/
SU_RESULT SUSelectionAdd(SUSelectionRef selection, size_t num_elements,
...
- \ref SU_ERROR_NULL_POINTER_INPUT if elements is NULL
*/
SU_RESULT SUSelectionRemove(SUSelectionRef selection, size_t num_elements,
    const SUDrawingElementRef elements[]);
...
- \ref SU_ERROR_NULL_POINTER_INPUT if elements is NULL
*/
SU_RESULT SUSelectionToggle(SUSelectionRef selection, size_t num_elements,
    const SUDrawingElementRef elements[]);
...
*/
SU_RESULT SUSelectionGetNumElements(SUSelectionRef selection,
    size_t* num_elements);
...
*/
SU_RESULT SUSelectionGetEntityList(SUSelectionRef selection,
...
*/
SU_RESULT SUSelectionIsType(SUSelectionRef selection, enum SUSelectionType type,
    bool* is_type);
